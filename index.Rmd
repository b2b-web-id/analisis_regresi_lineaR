...
link-citations: yes
github-repo: b2b-web-id/analisis-regresi-linier
---
...
Analisis Regresi Linear merupakan suatu uji untuk mengetahui hubungan antara satu variabel respon (Y), dengan satu atau lebih variabel prediktor (X). Dikatakan linier karena terdapat satu atau lebih variabel bebas/independen yang mempengaruhi variabel tak bebas/dependen.
